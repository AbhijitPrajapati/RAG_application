...
async def delete_collection(
    collection_id: int, request: Request, sql_db=Depends(get_db)
):
...
async def delete_collections_bulk(
    req: CollectionBulkDeletionRequest, request: Request, sql_db=Depends(get_db)
):
...
async def rename_collection(
    collection_id: int, req: CollectionRenameRequest, sql_db=Depends(get_db)
):
