...
@documents_router.get(
    "/collections/{collection_id}/files", response_model=list[FileResponse]
)
...
async def delete_files_bulk(
    req: FileBulkDeletionRequest, request: Request, sql_db=Depends(get_db)
):
